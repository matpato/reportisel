...
\lstfromfile{java,linerange={3-11}}{Operações elementares de uma Calculadora}{lst:Calculadora}{code-files/Calculadora.java}{showlines=true,morekeywords={tran,begin,return},basicstyle=\footnotesize\ttfamily}



\centering{\textbf{Written by Matilde Pós-de-Mina Pato\footnote{O autor escreve segundo o AO}, \\2017 March - 1st version}}