...
%% - Class of text
%%           (*)rpt		- Report
%%           preprpt		- Preliminary Report (in preparation)
%% - Languages
%%           (*)pt			- português
%%           en		- english
...
\documentclass[rpt,pt,twoside,12pt,a4paper,listof=totoc]{reportisel} 
...
% Where to find code files
\newcommand{\codefiles}[1]{../code-files/#1}
