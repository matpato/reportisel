...
\verb!\codejava{int i;}.!
If you wish to include pseudocode or algorithms see \href{http://en.wikibooks.org/wiki/LaTeX/Algorithms_and_Pseudocode}{\nolinkurl{LaTeX/Algorithms\_ and\_Pseudocode}}, as Listing ~\ref{lst:Calculadora}.
\vskip1em
%\lstfromfile{language}{caption}{label}{path}
\lstfromfile{java,linerange={3-11}}{Opera\c{c}\~{o}es elementares de uma Calculadora}{lst:Calculadora}{\codefiles{Calculadora.java}}{showlines=true,morekeywords={tran,begin,return},basicstyle=\footnotesize\ttfamily}


\centering{\textbf{Written by Matilde Pós-de-Mina Pato\footnote{O autor escreve segundo o AO}, \\2017 September -  version 1.1}}